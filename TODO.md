...
- [x] T009: Premiumゲート(trial_start_ts+Stripe)。無料は5件まで、Premiumで無制限+繰返し締切
- [x] T010: npm run build を通しts/lintを解消
- [x] T011: release/countdown.zip 生成(node_modules除外)
- [x] T012: legal/PRIVACY.md と TERMS.md(外部通信なし・データ収集なし・$3買い切り7日トライアル明記)
